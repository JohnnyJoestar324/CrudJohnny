...
namespace BaseDeDatosPrueba.Models
{
    public partial class AdventureWorks2019Context : DbContext
    {
        ...
        public virtual DbSet<UvwSalesByTerritory> UvwSalesByTerritories { get; set; } = null!;
        ...
        public virtual DbSet<VwDiscontinued> VwDiscontinueds { get; set; } = null!;
        public virtual DbSet<VwDocumentControl> VwDocumentControls { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-177N313;Database=AdventureWorks2019;Trusted_Connection=True;MultipleActiveResultSets=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UvwSalesByTerritory>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("uvw_SalesByTerritory", "Sales");
            ...
            modelBuilder.Entity<VwDiscontinued>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_Discontinued", "Production");
            ...
            modelBuilder.Entity<VwDocumentControl>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_DocumentControl", "Employee");
            ...
            modelBuilder.Entity<VwProduct>(entity =>
            {
                ...
                entity.ToView("vw_Product", "Production");
